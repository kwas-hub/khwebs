  ...
  public: {
    Tables: {
      api_endpoints: {
        ...
        Relationships: [
          {
            foreignKeyName: "api_endpoints_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
      ...
      content_blocks: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_blocks_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      document_type_keywords: {
        ...
        Relationships: [
          {
            foreignKeyName: "document_type_keywords_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      export_queue: {
        ...
        Relationships: [
          {
            foreignKeyName: "export_queue_endpoint_id_fkey"
            columns: ["endpoint_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "export_queue_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      external_calendars: {
        ...
        Relationships: [
          {
            foreignKeyName: "external_calendars_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      pdf_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "pdf_documents_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      pdf_pages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "pdf_pages_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
