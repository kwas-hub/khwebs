...
import { Plus, Trash2, ChevronUp, ChevronDown, Mail, MessageSquareWarning, Calendar, Clock, FileText, GripVertical, Eye, Copy } from "lucide-react";
...
const Formulare = () => {
  ...
  const duplicateForm = async (form: Form) => {
    ...
    if (formError) return toast.error(formError.message);
                ...
                <div className="space-y-1">
                  ...
                  {forms.length === 0 && (
                    <div className="text-center py-8 text-muted-foreground">
                      ...
                      {isTenantAdmin && (
                        <Button variant="outline" size="sm" onClick={addForm} className="mt-2">
              ...
              {activeForm ? (
                <div className="space-y-6">
                  ...
                  <AdminCard 
                    ...
                    description="Ziehe Felder per Drag & Drop, um sie anzuordnen"
                    actions={
                      isTenantAdmin && (
